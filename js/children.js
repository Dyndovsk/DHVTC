        ...
        printBtn.addEventListener('click', function() {
            ...
            const printContent = `
                ...
                <body>
                    ...
                    <div class="category">
                        <h2>👕 Одежда</h2>
                        <div class="item">☐ Головной убор <span class="note">Кепка, панама, бандана</span></div>
                        <div class="item">☐ Футболка <span class="note">Обязательно одна футболка полностью белая и дижинсовый низ для фотосессии</span></div>
                        <div class="item">☐ Шорты/юбки </div>
                        <div class="item">☐ Спортивный костюм </div>
                        <div class="item">☐ Нижнее белье и носки х/б</div>
                        <div class="item">☐ Красивая нарядная одежда <span class="note">По желанию</span></div>
                        <div class="item">☐ Одежда на случай дождя или холодной погоды</div>
                    </div>

                    <div class="category">
                        <h2>👟 Обувь</h2>
                        <div class="item">☐ Спортивная обувь для спортивных игр</div>
                        <div class="item">☐ Открытая обувь - сандалии, босоножки (без каблуков)</div>
                        <div class="item">☐ Обувь на случай дождя</div>
                        <div class="item">☐ Обувь, удобная для дома</div>
                        <div class="item">☐ Тапочки для душа</div>
                    </div>
                    
                    <div class="category">
                        <h2>🧼 Гигиена</h2>
                        <div class="item">☐ Зубная щетка (желательно в футляре) и паста</div>
                        <div class="item">☐ Мыло/гель для душа, мочалка, полотенца (лучше 2 шт)</div>
                        <div class="item">☐ Шампунь в небольшой пластиковой бутылке, которая хорошо закрывается</div>
                        <div class="item">☐ Расческа. Заколки и резинки для девочек</div>
                        <div class="item">☐ Платки носовые, желательно одноразовые</div>
                        <div class="item">☐ Средство от комаров, защитный крем от солнца <span class="note">Будет на всех, но можно взять</span></div>
                    ...
                    <div class="category">
                        <h2>⭐ Разное</h2>
                        <div class="item">☐ Библия (если есть), ручка</div>
                        <div class="item">☐ Любимая игрушка, книжка или что-то для рукоделия <span class="note">По желанию</span></div>
                        <div class="item">☐ Многоразовая бутылочка для воды <span class="note">Ёё нужно подписать, чтобы не потерять</span></div>
                        <div class="item">☐ При необходимости медикаменты, подписанные и инструкция как принимает их ребенок <span class="note">Лекарства будут у медсестры, прием и лечение будет проходить под присмотром мед персонала</span></div>
                    </div>
                    
                    <div class="footer">
                        <p>© 2026 Местная религиозная организация Церковь Евангельских Христиан "Твоя Церковь". Все права защищены.</p>
                        <p>Телефон: +7 926 340 8326</p>
                    </div>
                </body>
                </html>
            `;
